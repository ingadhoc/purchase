...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        ...
        b) if no seller was selected and price was not computed, then use standard price
        """
        ...
        for line in price_update_lines.filtered(
            lambda x: x.product_id and not x.price_unit and not x.selected_seller_id
        ):
